...
REP$tit <- 'Nota técnica para la construcción de tablas de mortalidad'
...
REP$fec_fin <- format( parametros$dem_fec_fin, '%Y-%m-%d' )
REP$fec_val <- format( ymd( '2019-12-31' ), '%Y-%m-%d' )
...
REP$file_latex_org <- c( paste( parametros$work_dir, 'Reportes/bibliografia_libros.bib', sep = '' ),
...
REP$file_latex_des <- c( paste( REP$rep_dir, 'bibliografia_libros.bib', sep = '' ), 
...
REP$file_latex_clean <- c( paste( REP$rep_dir, 'bibliografia_libros.bib', sep = '' ), 
                           paste( REP$rep_dir, 'bibliografia_articulos.bib', sep = '' ),
                           paste( REP$rep_dir, 'bibliografia_leyes.bib', sep = '' ),
                           paste( REP$rep_dir, 'style.tex', sep = '' ),
                           paste( REP$rep_dir, 'comandosEPN.sty', sep = '' ) )
