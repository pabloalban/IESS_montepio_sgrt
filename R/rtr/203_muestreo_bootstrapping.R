...
tab_est_porcentaje_of <- data.frame( causante = c( 'Afiliado', 'Jubilado' ),
...
tab_est_beneficarios_of <- data.frame( causante = c( 'Afiliado', 'Jubilado' ),
                                   tamano_muestra = c( n, n ),
...
tab_est_porcentaje_vo <- data.frame( causante = c( 'Afiliado', 'Jubilado' ),
                                  tamano_muestra = c( n, n ),
...
tab_est_beneficarios_vo <- data.frame( causante = c( 'Afiliado', 'Jubilado' ),
                                    tamano_muestra = c( n, n ),
