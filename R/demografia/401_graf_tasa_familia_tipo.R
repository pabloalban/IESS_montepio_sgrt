...
u_lst <- as.vector( quantile( aux_obs$u_obs, probs = seq( 0.0, 1, length.out = 101 ) ) )
u_lst <- sort( u_lst )
u_lst <- scales::rescale( u_lst, to = c( 0, 1 ) )
cols_graf <- cols_fun( length( u_lst ) )

plt_obs_hh <- ggplot() +
  geom_tile( data = aux_obs, aes( x = x, y = y, fill = u_obs ), alpha = 0.8 ) +
  labs( title = 'Tasas observadas', x = 'Edad padre x', y = 'Edad hijo y' ) + 
...
u_lst <- c( as.vector( quantile( aux_obs$u_obs, probs = seq( 0.01, 0.99, length.out = 101 ) ) ),
            as.vector( quantile( aux$u, probs = seq( 0, 1, length.out = 101 ) ) ) )
u_lst <- sort( u_lst )
u_lst <- scales::rescale( u_lst, to = c( 0, 1 ) )
cols_graf <- cols_fun( length( u_lst ) )
...
plt_hh <- ggplot() +
  ...
  labs( title = 'Tasas ajustadas', x = 'Edad padre x', y = 'Edad hijo y' ) + 
  scale_x_continuous( breaks = xbrk, expand = c( 0, 0 ), limits = xlim ) +
  scale_y_continuous( breaks = ybrk, expand = c( 0, 0 ), limits = ylim ) +
  scale_fill_gradientn( values = u_lst, colours = cols_graf ) +
  plt_theme 
...
plt_obs_hm <- ggplot() +
  geom_tile( data = aux_obs, aes( x = x, y = y, fill = u_obs ), alpha = 0.8 ) +
  labs( title = 'Tasas observadas', x = 'Edad padre x', y = 'Edad hija y' ) + 
  scale_x_continuous( breaks = xbrk, expand = c( 0, 0 ), limits = xlim ) +
  scale_y_continuous( breaks = ybrk, expand = c( 0, 0 ), limits = ylim ) +
  scale_fill_gradientn( values = u_lst, colours = cols_graf ) +
  plt_theme 
...
plt_hm <- ggplot() +
  geom_tile( data = aux, aes( x = x, y = y, fill = u ), alpha = 0.8 ) +
  labs( title = 'Tasas ajustadas', x = 'Edad padre x', y = 'Edad hija y' ) + 
  scale_x_continuous( breaks = xbrk, expand = c( 0, 0 ), limits = xlim ) +
  scale_y_continuous( breaks = ybrk, expand = c( 0, 0 ), limits = ylim ) +
  scale_fill_gradientn( values = u_lst, colours = cols_graf ) +
  plt_theme 
...
plt_obs_mh <- ggplot() +
  geom_tile( data = aux_obs, aes( x = x, y = y, fill = u_obs ), alpha = 0.8 ) +
  labs( title = 'Tasas observadas', x = 'Edad madre x', y = 'Edad hijo y' ) + 
  scale_x_continuous( breaks = xbrk, expand = c( 0, 0 ), limits = xlim ) +
  scale_y_continuous( breaks = ybrk, expand = c( 0, 0 ), limits = ylim ) +
  scale_fill_gradientn( values = u_lst, colours = cols_graf ) +
  theme_bw() +
...
plt_mh <- ggplot() +
  geom_tile( data = aux, aes( x = x, y = y, fill = u ), alpha = 0.8 ) +
  labs( title = 'Tasas ajustadas', x = 'Edad madre x', y = 'Edad hijo y' ) + 
  scale_x_continuous( breaks = xbrk, expand = c( 0, 0 ), limits = xlim ) +
  scale_y_continuous( breaks = ybrk, expand = c( 0, 0 ), limits = ylim ) +
  scale_fill_gradientn( values = u_lst, colours = cols_graf ) +
  theme_bw() +
...
plt_obs_mm <- ggplot() +
  geom_tile( data = aux_obs, aes( x = x, y = y, fill = u_obs ), alpha = 0.8) +
  labs( title = 'Tasas observadas', x = 'Edad madre x', y = 'Edad hija y' ) + 
  scale_x_continuous( breaks = xbrk, expand = c( 0, 0 ), limits = xlim ) +
  scale_y_continuous( breaks = ybrk, expand = c( 0, 0 ), limits = ylim ) +
  scale_fill_gradientn( values = u_lst, colours = cols_graf ) +
  plt_theme 
...
plt_mm <- ggplot() +
  geom_tile( data = aux, aes( x = x, y = y, fill = u ), alpha = 0.8 ) +
  labs( title = 'Tasas ajustadas', x = 'Edad madre x', y = 'Edad hija y' ) + 
  scale_x_continuous( breaks = xbrk, expand = c( 0, 0 ), limits = xlim ) +
  scale_y_continuous( breaks = ybrk, expand = c( 0, 0 ), limits = ylim ) +
  scale_fill_gradientn( values = u_lst, colours = cols_graf ) +
  plt_theme 
...
plt_obs_cony <- ggplot() +
  geom_tile( data = aux_obs, aes( x = x, y = y, fill = u_obs ), alpha = 0.8 ) +
  labs( title = 'Tasas observadas', x = 'Edad afiliado x', y = 'Edad cónyuge y' ) + 
  scale_x_continuous( breaks = xbrk, expand = c( 0, 0 ), limits = xlim ) +
  scale_y_continuous( breaks = ybrk, expand = c( 0, 0 ), limits = ylim ) +
  scale_fill_gradientn( values = u_lst, colours = cols_graf ) +
  plt_theme
...
plt_cony <- ggplot() +
  geom_tile( data = aux, aes( x = x, y = y, fill = u ), alpha = 0.8 ) +
  labs( title = 'Tasas ajustadas', x = 'Edad afiliado x', y = 'Edad cónyuge y' ) +
  scale_x_continuous( breaks = xbrk, expand = c( 0, 0 ), limits = xlim ) +
  scale_y_continuous( breaks = ybrk, expand = c( 0, 0 ), limits = ylim ) +
